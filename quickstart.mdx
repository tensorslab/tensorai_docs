...
<CardGroup cols={2}>
  <Card title="Image Models" icon="image">
    - **Nano Banana**: Fast, efficient image generation by Google
    - **Seedream4**: Professional-level quality by ByteDance
  </Card>
  <Card title="Video Models" icon="video">
    - **Seedance**: High-quality multi-style video generation
    - **Veo3**: Google's advanced video generation technology
  </Card>
</CardGroup>
